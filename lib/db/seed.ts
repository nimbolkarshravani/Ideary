...
const SEED_DATA: DbInsert[] = [
  ...
  },
  {
    ...
    why_it_could_work: [
      ...
      "No direct competitor exists with the specific combination of verified creators, witness system, and coordinated reporting.",
      "India market is underserved: 67.2% male Instagram userbase means Indian female creators face disproportionate harassment.",
    ...
    why_it_might_not: [
      "Legal liability is fatal for a solo founder. Coordinating mass reports against named individuals exposes the platform to defamation suits.",
      "Report-bombing risk: the exact feature meant to protect women can be weaponized.",
      "Harassment database paradox: a public feed of female creators' experiences becomes a goldmine for coordinated harassment groups.",
      "Moderation at scale is brutally expensive and causes severe secondary trauma.",
    ...
    revisit_if:
      "Access to a cyber law attorney on retainer, 50L+ in funding, or scope shifts to pure community (no harassment documentation).",
    what_itd_take: [
    ...
    next_step: null,
    at_a_glance: { effort: "massive", cost: "massive", fit: "weak", time: "year-plus" },
    custom_notes: null,
  },
];
